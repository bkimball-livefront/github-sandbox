...
Open animals.ts and update the animalByLetter array by replcaing Bear -> Black Bear
```diff
- 'Bear',
+ 'Black Bear',
```
...
In your IDE of choice (I'll be using Visual Studio Code for my examples) navigate to the file where you're having the merge conflicts `lesson-one`.